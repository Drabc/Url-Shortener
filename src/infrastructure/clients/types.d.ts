...
import { MONGO_CLIENT, REDIS_CLIENT, POSTGRES_CLIENT } from '@infrastructure/constants.ts'
import { PgClient } from '@infrastructure/clients/pg-client.ts'

export type ClientKey = typeof MONGO_CLIENT | typeof REDIS_CLIENT | typeof POSTGRES_CLIENT
